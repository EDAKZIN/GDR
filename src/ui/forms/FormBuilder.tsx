...
const checkboxClass = "h-3.5 w-3.5 accent-teal-500";
    ...
    <section className="flex min-h-0 flex-1 flex-col gap-3">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    title="Editar"
                    className="rounded-md p-1 text-zinc-500 transition-colors hover:bg-zinc-700 hover:text-teal-300"
                    onClick={() => {
                      startEdit(field);
                    }}
                  >
                ...
                {disabledFields.map((field) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="rounded-md p-1 text-zinc-500 transition-colors hover:text-teal-300"
                      onClick={() => {
                ...
                {deletedFields.map((field) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="shrink-0 rounded-md border border-zinc-700 px-1.5 py-0.5 text-[11px] text-zinc-300 transition-colors hover:border-teal-400 hover:text-teal-300"
                      onClick={() => {
      ...
      >
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            type="submit"
            className="inline-flex items-center gap-1.5 rounded-md bg-teal-600 px-3 py-1.5 text-xs font-semibold text-white transition-colors hover:bg-teal-500 disabled:cursor-not-allowed disabled:opacity-50"
