...
const selectClass =
  "rounded-md border border-zinc-700 bg-zinc-900 px-2 py-1.5 text-xs text-zinc-200 outline-none focus:border-teal-400";
    ...
    <section className="flex min-h-0 flex-1 flex-col gap-3">
      <header className="flex flex-wrap items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          ...
          <button
            type="button"
            className="rounded-md border border-zinc-700 bg-zinc-900 p-1.5 text-zinc-300 transition-colors hover:border-teal-400 hover:text-teal-300"
            onClick={() => {
              setSorting({
              ...
              <li key={record.id}>
                <div
                  className={`group flex items-center justify-between gap-2 rounded-md border px-3 py-2 transition-colors ${
                    deleted
                      ...
                      : "cursor-pointer border-zinc-800 bg-zinc-900 hover:border-teal-500/50"
                  }`}
                  onClick={() => {
                    if (!deleted) {
                ...
                >
                  ...
                  {deleted ? (
                    <button
                      type="button"
                      className="inline-flex shrink-0 items-center gap-1 rounded-md border border-zinc-700 px-2 py-1 text-xs text-zinc-300 transition-colors hover:border-teal-400 hover:text-teal-300"
                      onClick={(event) => {
